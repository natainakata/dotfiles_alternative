...
local spec = {
  {
    ...
    config = function()
      helper.ddu.ff_map(nil, function(map)
        -- Highlight cursor line
        vim.opt_local.cursorline = true
        -- Default itemAction
        map("<CR>", helper.ddu.item_action("default"))
      end)
      helper.ddu.ff_filter_map(nil, function(map)
        -- Default itemAction
        map("i", "<CR>", helper.ddu.item_action("default", nil, true))
        map("n", "<CR>", helper.ddu.item_action("default"))
      end)
